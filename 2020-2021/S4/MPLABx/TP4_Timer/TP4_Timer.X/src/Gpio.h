...
/* Prototypes for Gpio */
void gpio_Init(void);       // Initialize Input Output GPIO TOR                 
void gpio_Set(unsigned char, unsigned char); // Setup state of led (D3-D9) at On/Off  
void gpio_Toggle(unsigned char);    // Invert state of led D-D9 (0->1, 1->0)    
