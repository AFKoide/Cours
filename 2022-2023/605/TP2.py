...
plt.axvline(0.06,color='g',linestyle='-.')
...
print("Le temps de réponse est: 0.06")
...
plt.axvline(0.148,color='g',linestyle='-.')
...
print("Erreur de position: ",1-y[-1])
print("Le temps de réponse est: 0.148 (environ)",)
...
plt.axhline(1,color='k',linestyle='--')
plt.axhline(y[-1]+0.05,color='g',linestyle='-.');plt.axhline(y[-1]-0.05,color='g',linestyle='-.');
plt.axvline(0.125,color='g',linestyle='-.')
...
print("Erreur de position: ",1-y[-1])
print("Le temps de réponse est: 0.125 (environ)")
